...
# Attacks too slow for NUC Phase 4 at full-dataset scale.
...
def run_sweep(
    *,
    ...
    team_summary: bool | None = None,
    failure_gallery: bool | None = None,
    compat_dashboard: bool | None = None,
) -> bool:
    ...
    if team_summary is True:
        cmd.append("--team-summary")
    if team_summary is False:
        cmd.append("--no-team-summary")
    if failure_gallery is True:
        cmd.append("--failure-gallery")
    if failure_gallery is False:
        cmd.append("--no-failure-gallery")
    if compat_dashboard is True:
