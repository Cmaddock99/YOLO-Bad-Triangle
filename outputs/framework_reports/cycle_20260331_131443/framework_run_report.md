...
Total discovered framework runs: **73**
...
| `validate_deepfool_median_preprocess` | `yolo` | `deepfool` | `median_preprocess` | `complete` | 0.1522 | 0.7363 |
...
| `validate_dispersion_reduction_median_preprocess` | `yolo` | `dispersion_reduction` | `median_preprocess` | `complete` | 0.1758 | 0.7059 |
...
| `validate_square_median_preprocess` | `yolo` | `square` | `median_preprocess` | `complete` | 0.3336 | 0.7137 |
...
| `yolo` | `deepfool` | `median_preprocess` | `untargeted_conf_suppression` |  | `` |  | 0.1522 |  |
| `yolo` | `dispersion_reduction` | `bit_depth` | `` |  | `` |  | 0.2319 |  |
| `yolo` | `dispersion_reduction` | `c_dog` | `` |  | `` |  | 0.2632 |  |
| `yolo` | `dispersion_reduction` | `median_preprocess` | `` |  | `` |  | 0.1758 |  |
| `yolo` | `square` | `bit_depth` | `` |  | `` |  | 0.3863 |  |
| `yolo` | `square` | `c_dog` | `` |  | `` |  | 0.3890 |  |
| `yolo` | `square` | `median_preprocess` | `` |  | `` |  | 0.3336 |  |
