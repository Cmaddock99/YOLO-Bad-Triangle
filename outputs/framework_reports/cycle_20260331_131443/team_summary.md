...
- Total discovered runs: **73**
- Attack runs analyzed: **71**
- Baseline run: `baseline_none`

## Headline

- Strongest attack (by detection drop): `deepfool` (100.0%)
...
|---|---|---:|---:|---:|---|---|
| `tune_def_median_preprocess_scan__kernel_size17_vs_deepfool` | `deepfool` | 100.0% | n/a | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_scan__kernel_size31_vs_deepfool` | `deepfool` | 100.0% | n/a | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_scan__kernel_size31_vs_square` | `square` | 98.0% | 0.7438 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_scan__kernel_size17_vs_square` | `square` | 97.0% | 0.8110 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `tune_def_median_preprocess__kernel_size3_vs_deepfool` | `deepfool` | 89.0% | 0.7885 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_scan__kernel_size3_vs_deepfool` | `deepfool` | 89.0% | 0.7885 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `tune_def_median_preprocess__kernel_size5_vs_square` | `square` | 88.0% | 0.7365 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `tune_def_median_preprocess__kernel_size3_vs_square` | `square` | 84.0% | 0.7127 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_scan__kernel_size3_vs_square` | `square` | 84.0% | 0.7127 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `validate_dispersion_reduction_median_preprocess` | `dispersion_reduction` | 71.0% | 0.7059 | 0.1758 | ✓ mAP50 | Strong attack effect |
| `validate_dispersion_reduction_bit_depth` | `dispersion_reduction` | 65.0% | 0.7128 | 0.2319 | ✓ mAP50 | Strong attack effect |
...
| `validate_dispersion_reduction_c_dog` | `dispersion_reduction` | 53.0% | 0.7244 | 0.2632 | ✓ mAP50 | Strong attack effect |
...
| `validate_square_bit_depth` | `square` | 19.0% | 0.7466 | 0.3863 | ✓ mAP50 | Strong attack effect |
| `defended_square_jpeg_preprocess` | `square` | 17.0% | 0.7403 | n/a | proxy (avg_conf) | Strong attack effect |
| `validate_square_median_preprocess` | `square` | 17.0% | 0.7137 | 0.3336 | ✓ mAP50 | Strong attack effect |
...
| `validate_square_c_dog` | `square` | 7.0% | 0.7274 | 0.3890 | ✓ mAP50 | Strong attack effect |
...
| `validate_deepfool_median_preprocess` | `deepfool` | -84.0% | 0.7363 | 0.1522 | ✓ mAP50 | Strong attack effect |
| `validate_deepfool_bit_depth` | `deepfool` | -155.0% | 0.7465 | 0.2229 | ✓ mAP50 | Strong attack effect |
| `validate_atk_deepfool` | `deepfool` | -160.0% | 0.7562 | 0.2184 | ✓ mAP50 | Strong attack effect |
| `validate_deepfool_c_dog` | `deepfool` | -177.0% | 0.7533 | 0.2403 | ✓ mAP50 | Strong attack effect |