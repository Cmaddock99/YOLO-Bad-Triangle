...
- Total discovered runs: **74**
- Attack runs analyzed: **72**
- Baseline run: `baseline_none`

## Headline

- Strongest attack (by detection drop): `square` (98.0%)
...
|---|---|---:|---:|---:|---|---|
| `tune_def_median_preprocess_scan__kernel_size31_vs_square` | `square` | 98.0% | 0.8561 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_scan__kernel_size17_vs_square` | `square` | 94.0% | 0.6728 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_atk_square__eps0.3__n_queries500` | `square` | 91.0% | 0.7832 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_c_dog__sharpen_alpha0.7__timestep25_vs_deepfool` | `deepfool` | 91.0% | 0.8638 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_scan__kernel_size31_vs_deepfool` | `deepfool` | 91.0% | 0.6789 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_atk_deepfool__epsilon0.2__steps50` | `deepfool` | 90.0% | 0.8045 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_c_dog__sharpen_alpha0.55__timestep25_vs_deepfool` | `deepfool` | 90.0% | 0.8381 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_atk_deepfool__epsilon0.1__steps20` | `deepfool` | 89.0% | 0.7574 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_c_dog__sharpen_alpha0.55__timestep10_vs_deepfool` | `deepfool` | 89.0% | 0.8093 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_c_dog__sharpen_alpha0.55__timestep40_vs_deepfool` | `deepfool` | 89.0% | 0.8128 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `tune_def_c_dog__sharpen_alpha0.35__timestep25_vs_deepfool` | `deepfool` | 88.0% | 0.7934 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `tune_def_median_preprocess_scan__kernel_size3_vs_square` | `square` | 87.0% | 0.7464 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_atk_deepfool__epsilon0.05__steps50` | `deepfool` | 86.0% | 0.7463 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_c_dog__sharpen_alpha0.55__timestep25_vs_square` | `square` | 85.0% | 0.7456 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `tune_def_c_dog__sharpen_alpha0.55__timestep10_vs_square` | `square` | 84.0% | 0.7334 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_c_dog__sharpen_alpha0.55__timestep40_vs_square` | `square` | 84.0% | 0.7459 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_c_dog__sharpen_alpha0.7__timestep25_vs_square` | `square` | 84.0% | 0.7260 | n/a | proxy (avg_conf) | Strong attack effect |
| `defended_deepfool_c_dog` | `deepfool` | 83.0% | 0.7788 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_c_dog__sharpen_alpha0.35__timestep25_vs_square` | `square` | 83.0% | 0.7332 | n/a | proxy (avg_conf) | Strong attack effect |
| `attack_square` | `square` | 82.0% | 0.7183 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_scan__kernel_size17_vs_deepfool` | `deepfool` | 81.0% | 0.7072 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `tune_def_median_preprocess_scan__kernel_size3_vs_deepfool` | `deepfool` | 77.0% | 0.7483 | n/a | proxy (avg_conf) | Strong attack effect |
