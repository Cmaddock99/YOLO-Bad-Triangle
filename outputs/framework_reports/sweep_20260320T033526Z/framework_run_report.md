...
| `attack_deepfool` | `yolo` | `deepfool` | `none` | `missing` |  | 0.7478 |
| `attack_fgsm` | `yolo` | `fgsm` | `none` | `missing` |  | 0.7522 |
| `attack_pgd` | `yolo` | `pgd` | `none` | `missing` |  | 0.7786 |
...
| `yolo` | `none` | 42 | `attack_deepfool` | `deepfool` |  | 0.0180 |
| `yolo` | `none` | 42 | `attack_fgsm` | `fgsm` |  | 0.0136 |
| `yolo` | `none` | 42 | `attack_pgd` | `pgd` |  | -0.0128 |