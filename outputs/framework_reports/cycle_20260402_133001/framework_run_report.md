...
Total discovered framework runs: **74**
...
| `tune_def_bit_depth__bits5_vs_deepfool` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7622 |
| `tune_def_bit_depth__bits5_vs_square` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7585 |
| `tune_def_bit_depth__bits6_vs_deepfool` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7614 |
| `tune_def_bit_depth__bits6_vs_square` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7469 |
| `tune_def_bit_depth__bits7_vs_deepfool` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7456 |
| `tune_def_bit_depth__bits7_vs_square` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7353 |
| `tune_def_c_dog__sharpen_alpha0.35__timestep25_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7934 |
| `tune_def_c_dog__sharpen_alpha0.35__timestep25_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7332 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep10_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.8093 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep10_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7334 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep25_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.8381 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep25_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7456 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep40_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.8128 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep40_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7459 |
| `tune_def_c_dog__sharpen_alpha0.7__timestep25_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.8638 |
| `tune_def_c_dog__sharpen_alpha0.7__timestep25_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7260 |
...
| `validate_deepfool_bit_depth` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `complete` | 0.2290 | 0.7621 |
| `validate_deepfool_c_dog` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `complete` | 0.2065 | 0.7552 |
| `validate_deepfool_jpeg_preprocess` | `yolo` | `deepfool` | `jpeg_preprocess` | `attack_then_defense` | `complete` | 0.3175 | 0.7632 |
| `validate_dispersion_reduction_bit_depth` | `yolo` | `dispersion_reduction` | `bit_depth` | `attack_then_defense` | `complete` | 0.2448 | 0.6899 |
| `validate_dispersion_reduction_c_dog` | `yolo` | `dispersion_reduction` | `c_dog` | `attack_then_defense` | `complete` | 0.2164 | 0.7168 |
...
| `validate_square_bit_depth` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `complete` | 0.3499 | 0.7123 |
| `validate_square_c_dog` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `complete` | 0.3624 | 0.7132 |
...
| `yolo` | `deepfool` | `jpeg_preprocess` | `untargeted_conf_suppression` |  | `` |  |  |  |
| `yolo` | `square` | `jpeg_preprocess` | `` |  | `` |  |  |  |
| `yolo` | `deepfool` | `bit_depth` | `untargeted_conf_suppression` |  | `` |  | 0.2290 |  |
| `yolo` | `deepfool` | `c_dog` | `untargeted_conf_suppression` |  | `` |  | 0.2065 |  |
| `yolo` | `deepfool` | `jpeg_preprocess` | `untargeted_conf_suppression` |  | `` |  | 0.3175 |  |
| `yolo` | `dispersion_reduction` | `bit_depth` | `` |  | `` |  | 0.2448 |  |
| `yolo` | `dispersion_reduction` | `c_dog` | `` |  | `` |  | 0.2164 |  |
| `yolo` | `dispersion_reduction` | `jpeg_preprocess` | `` |  | `` |  | 0.2040 |  |
| `yolo` | `square` | `bit_depth` | `` |  | `` |  | 0.3499 |  |
| `yolo` | `square` | `c_dog` | `` |  | `` |  | 0.3624 |  |
| `yolo` | `square` | `jpeg_preprocess` | `` |  | `` |  | 0.3247 |  |
