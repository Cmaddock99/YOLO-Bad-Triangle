...
Total discovered framework runs: **54**
...
| `tune_def_median_preprocess_001` | `yolo` | `deepfool` | `median_preprocess` | `missing` |  | 0.8709 |
| `tune_def_median_preprocess_002` | `yolo` | `deepfool` | `median_preprocess` | `missing` |  | 0.8289 |
| `tune_def_median_preprocess_003` | `yolo` | `deepfool` | `median_preprocess` | `missing` |  | 0.7835 |
