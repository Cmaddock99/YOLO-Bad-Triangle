...
Total discovered framework runs: **61**
...
| `tune_atk_blur_001` | `yolo` | `blur` | `none` | `missing` |  | 0.7566 |
| `tune_atk_blur_002` | `yolo` | `blur` | `none` | `missing` |  | 0.7387 |
| `tune_atk_blur_003` | `yolo` | `blur` | `none` | `missing` |  | 0.7749 |
| `tune_atk_blur_004` | `yolo` | `blur` | `none` | `missing` |  | 0.7286 |
| `tune_atk_blur_005` | `yolo` | `blur` | `none` | `missing` |  | 0.7566 |
| `tune_atk_blur_006` | `yolo` | `blur` | `none` | `missing` |  | 0.7260 |
| `tune_atk_blur_007` | `yolo` | `blur` | `none` | `missing` |  | 0.7387 |
| `tune_atk_blur_008` | `yolo` | `blur` | `none` | `missing` |  | 0.7163 |
| `tune_atk_blur_009` | `yolo` | `blur` | `none` | `missing` |  | 0.7286 |
| `tune_atk_blur_010` | `yolo` | `blur` | `none` | `missing` |  | 0.7319 |
| `tune_atk_blur_011` | `yolo` | `blur` | `none` | `missing` |  | 0.7260 |
| `tune_atk_gaussian_blur_001` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7566 |
| `tune_atk_gaussian_blur_002` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7387 |
| `tune_atk_gaussian_blur_003` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7749 |
| `tune_atk_gaussian_blur_004` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7286 |
| `tune_atk_gaussian_blur_005` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7566 |
| `tune_atk_gaussian_blur_006` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7260 |
| `tune_atk_gaussian_blur_007` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7387 |
| `tune_atk_gaussian_blur_008` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7163 |
| `tune_atk_gaussian_blur_009` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7286 |
| `tune_atk_gaussian_blur_010` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7319 |
| `tune_atk_gaussian_blur_011` | `yolo` | `gaussian_blur` | `none` | `missing` |  | 0.7260 |
...
| `tune_def_confidence_filter_001` | `yolo` | `gaussian_blur` | `confidence_filter` | `missing` |  | 0.8429 |
| `tune_def_confidence_filter_002` | `yolo` | `gaussian_blur` | `confidence_filter` | `missing` |  | 0.8766 |
| `tune_def_confidence_filter_003` | `yolo` | `gaussian_blur` | `confidence_filter` | `missing` |  | 0.8113 |
| `tune_def_confidence_filter_004` | `yolo` | `gaussian_blur` | `confidence_filter` | `missing` |  | 0.9375 |
| `tune_def_confidence_filter_005` | `yolo` | `gaussian_blur` | `confidence_filter` | `missing` |  | 0.8429 |
| `tune_def_confidence_filter_006` | `yolo` | `gaussian_blur` | `confidence_filter` | `missing` |  | 0.8766 |
