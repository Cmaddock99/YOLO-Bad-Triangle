...
Total discovered framework runs: **114**
...
| `tune_atk_deepfool__epsilon0.07625__steps170` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.7787 |
| `tune_atk_deepfool__epsilon0.07625__steps200` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.7676 |
| `tune_atk_deepfool__epsilon0.1525__steps200` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.8117 |
| `tune_atk_deepfool__epsilon0.3__steps200` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.8269 |
| `tune_atk_deepfool_best` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.7676 |
| `tune_atk_deepfool_scan__epsilon0.005__steps50` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.7779 |
| `tune_atk_deepfool_scan__epsilon0.05__steps10` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.7713 |
| `tune_atk_deepfool_scan__epsilon0.05__steps105` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.7491 |
| `tune_atk_deepfool_scan__epsilon0.05__steps200` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.7443 |
| `tune_atk_deepfool_scan__epsilon0.1525__steps50` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.8121 |
| `tune_atk_deepfool_scan__epsilon0.3__steps50` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `missing` |  | 0.8248 |
...
| `tune_atk_dispersion_reduction_scan__epsilon0.01__steps50` | `yolo` | `dispersion_reduction` | `none` | `attack_then_defense` | `missing` |  | 0.7785 |
| `tune_atk_dispersion_reduction_scan__epsilon0.05__steps100` | `yolo` | `dispersion_reduction` | `none` | `attack_then_defense` | `missing` |  | 0.7943 |
| `tune_atk_dispersion_reduction_scan__epsilon0.05__steps20` | `yolo` | `dispersion_reduction` | `none` | `attack_then_defense` | `missing` |  | 0.7780 |
| `tune_atk_dispersion_reduction_scan__epsilon0.05__steps60` | `yolo` | `dispersion_reduction` | `none` | `attack_then_defense` | `missing` |  | 0.7913 |
| `tune_atk_dispersion_reduction_scan__epsilon0.08__steps50` | `yolo` | `dispersion_reduction` | `none` | `attack_then_defense` | `missing` |  | 0.7588 |
| `tune_atk_dispersion_reduction_scan__epsilon0.15__steps50` | `yolo` | `dispersion_reduction` | `none` | `attack_then_defense` | `missing` |  | 0.7524 |
| `tune_atk_square__eps0.15__n_queries450` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7627 |
| `tune_atk_square__eps0.15__n_queries500` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7463 |
| `tune_atk_square__eps0.3__n_queries425` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7607 |
| `tune_atk_square__eps0.3__n_queries450` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7082 |
| `tune_atk_square__eps0.3__n_queries475` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7895 |
...
| `tune_atk_square_scan__eps0.01__n_queries100` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7790 |
| `tune_atk_square_scan__eps0.05__n_queries275` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7583 |
| `tune_atk_square_scan__eps0.05__n_queries50` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7575 |
| `tune_atk_square_scan__eps0.05__n_queries500` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7255 |
| `tune_atk_square_scan__eps0.155__n_queries100` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7455 |
| `tune_atk_square_scan__eps0.3__n_queries100` | `yolo` | `square` | `none` | `attack_then_defense` | `missing` |  | 0.7701 |
| `tune_def_bit_depth__bits3_vs_deepfool` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7877 |
| `tune_def_bit_depth__bits3_vs_square` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7375 |
| `tune_def_bit_depth__bits4_vs_deepfool` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7314 |
| `tune_def_bit_depth__bits4_vs_square` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7484 |
| `tune_def_bit_depth_scan__bits3_vs_deepfool` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7877 |
| `tune_def_bit_depth_scan__bits3_vs_square` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7375 |
| `tune_def_bit_depth_scan__bits5_vs_deepfool` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7622 |
| `tune_def_bit_depth_scan__bits5_vs_square` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7585 |
| `tune_def_bit_depth_scan__bits7_vs_deepfool` | `yolo` | `deepfool` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7456 |
| `tune_def_bit_depth_scan__bits7_vs_square` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `missing` |  | 0.7353 |
| `tune_def_c_dog__sharpen_alpha0.2__timestep10_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7809 |
| `tune_def_c_dog__sharpen_alpha0.2__timestep10_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7391 |
| `tune_def_c_dog__sharpen_alpha0__timestep10_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7778 |
| `tune_def_c_dog__sharpen_alpha0__timestep10_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7436 |
| `tune_def_c_dog__sharpen_alpha0__timestep25_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7552 |
| `tune_def_c_dog__sharpen_alpha0__timestep25_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7368 |
| `tune_def_c_dog_scan__sharpen_alpha0.35__timestep50_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7739 |
| `tune_def_c_dog_scan__sharpen_alpha0.35__timestep50_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7372 |
| `tune_def_c_dog_scan__sharpen_alpha0.7__timestep50_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7887 |
| `tune_def_c_dog_scan__sharpen_alpha0.7__timestep50_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7330 |
| `tune_def_c_dog_scan__sharpen_alpha0__timestep10_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7778 |
| `tune_def_c_dog_scan__sharpen_alpha0__timestep10_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7436 |
| `tune_def_c_dog_scan__sharpen_alpha0__timestep50_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7777 |
| `tune_def_c_dog_scan__sharpen_alpha0__timestep50_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7411 |
| `tune_def_c_dog_scan__sharpen_alpha0__timestep90_vs_deepfool` | `yolo` | `deepfool` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7463 |
| `tune_def_c_dog_scan__sharpen_alpha0__timestep90_vs_square` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `missing` |  | 0.7448 |
...
| `tune_def_jpeg_preprocess_scan__quality40_vs_deepfool` | `yolo` | `deepfool` | `jpeg_preprocess` | `attack_then_defense` | `missing` |  | 0.7668 |
| `tune_def_jpeg_preprocess_scan__quality40_vs_square` | `yolo` | `square` | `jpeg_preprocess` | `attack_then_defense` | `missing` |  | 0.7867 |
| `tune_def_jpeg_preprocess_scan__quality68_vs_deepfool` | `yolo` | `deepfool` | `jpeg_preprocess` | `attack_then_defense` | `missing` |  | 0.7480 |
| `tune_def_jpeg_preprocess_scan__quality68_vs_square` | `yolo` | `square` | `jpeg_preprocess` | `attack_then_defense` | `missing` |  | 0.7399 |
| `tune_def_jpeg_preprocess_scan__quality95_vs_deepfool` | `yolo` | `deepfool` | `jpeg_preprocess` | `attack_then_defense` | `missing` |  | 0.7544 |
| `tune_def_jpeg_preprocess_scan__quality95_vs_square` | `yolo` | `square` | `jpeg_preprocess` | `attack_then_defense` | `missing` |  | 0.7194 |
...
| `tune_def_median_preprocess_scan__kernel_size17_vs_deepfool` | `yolo` | `deepfool` | `median_preprocess` | `attack_then_defense` | `missing` |  | 0.7072 |
| `tune_def_median_preprocess_scan__kernel_size17_vs_square` | `yolo` | `square` | `median_preprocess` | `attack_then_defense` | `missing` |  | 0.6728 |
| `tune_def_median_preprocess_scan__kernel_size31_vs_deepfool` | `yolo` | `deepfool` | `median_preprocess` | `attack_then_defense` | `missing` |  | 0.6789 |
| `tune_def_median_preprocess_scan__kernel_size31_vs_square` | `yolo` | `square` | `median_preprocess` | `attack_then_defense` | `missing` |  | 0.8561 |
| `tune_def_median_preprocess_scan__kernel_size3_vs_deepfool` | `yolo` | `deepfool` | `median_preprocess` | `attack_then_defense` | `missing` |  | 0.7483 |
| `tune_def_median_preprocess_scan__kernel_size3_vs_square` | `yolo` | `square` | `median_preprocess` | `attack_then_defense` | `missing` |  | 0.7464 |
| `validate_atk_deepfool` | `yolo` | `deepfool` | `none` | `attack_then_defense` | `complete` | 0.2422 | 0.7549 |
...
| `validate_dispersion_reduction_bit_depth` | `yolo` | `dispersion_reduction` | `bit_depth` | `attack_then_defense` | `complete` | 0.2416 | 0.7142 |
| `validate_dispersion_reduction_c_dog` | `yolo` | `dispersion_reduction` | `c_dog` | `attack_then_defense` | `complete` | 0.2218 | 0.7108 |
| `validate_dispersion_reduction_jpeg_preprocess` | `yolo` | `dispersion_reduction` | `jpeg_preprocess` | `attack_then_defense` | `complete` | 0.2076 | 0.7027 |
| `validate_dispersion_reduction_median_preprocess` | `yolo` | `dispersion_reduction` | `median_preprocess` | `attack_then_defense` | `complete` | 0.3042 | 0.7399 |
| `validate_square_bit_depth` | `yolo` | `square` | `bit_depth` | `attack_then_defense` | `complete` | 0.3026 | 0.7243 |
| `validate_square_c_dog` | `yolo` | `square` | `c_dog` | `attack_then_defense` | `complete` | 0.3942 | 0.7376 |
...
| `yolo` | 42 | `square` | `` |  | `` |  |  |  |  |
| `yolo` | 42 | `square` | `` |  | `` |  |  |  |  |
| `yolo` | 42 | `deepfool` | `untargeted_conf_suppression` |  | `` | 0.6002 | 0.2422 | 0.3580 | 59.7% |
...
| `yolo` | `deepfool` | `median_preprocess` | `untargeted_conf_suppression` |  | `` |  |  |  |
| `yolo` | `square` | `median_preprocess` | `` |  | `` |  |  |  |
| `yolo` | `dispersion_reduction` | `bit_depth` | `` |  | `` | 0.2381 | 0.2416 | 1.0% |
| `yolo` | `dispersion_reduction` | `c_dog` | `` |  | `` | 0.2381 | 0.2218 | -4.5% |
| `yolo` | `dispersion_reduction` | `jpeg_preprocess` | `` |  | `` | 0.2381 | 0.2076 | -8.4% |
| `yolo` | `dispersion_reduction` | `median_preprocess` | `` |  | `` | 0.2381 | 0.3042 | 18.3% |
| `yolo` | `square` | `bit_depth` | `` |  | `` | 0.3630 | 0.3026 | -25.4% |
| `yolo` | `square` | `c_dog` | `` |  | `` | 0.3630 | 0.3942 | 13.2% |
...
| `yolo` | 42 | `deepfool` | 47 | apple | 2 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 55 | cake | 1 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 56 | chair | 4 | 3 | 25.0% |
| `yolo` | 42 | `deepfool` | 58 | potted plant | 2 | 2 | 0.0% |
| `yolo` | 42 | `deepfool` | 59 | bed | 2 | 1 | 50.0% |
| `yolo` | 42 | `deepfool` | 60 | dining table | 2 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 62 | tv | 3 | 1 | 66.7% |
| `yolo` | 42 | `deepfool` | 63 | laptop | 2 | 1 | 50.0% |
...
| `yolo` | 42 | `dispersion_reduction` | 74 | clock | 1 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 77 | teddy bear | 2 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 0 | person | 43 | 21 | 51.2% |
| `yolo` | 42 | `dispersion_reduction` | 2 | car | 3 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 4 | airplane | 2 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 5 | bus | 4 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 7 | truck | 1 | 0 | 100.0% |
...
| `yolo` | 42 | `dispersion_reduction` | 47 | apple | 2 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 55 | cake | 1 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 56 | chair | 4 | 3 | 25.0% |
| `yolo` | 42 | `dispersion_reduction` | 58 | potted plant | 2 | 3 | -50.0% |
| `yolo` | 42 | `dispersion_reduction` | 59 | bed | 2 | 1 | 50.0% |
| `yolo` | 42 | `dispersion_reduction` | 60 | dining table | 2 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 62 | tv | 3 | 1 | 66.7% |
| `yolo` | 42 | `dispersion_reduction` | 63 | laptop | 2 | 0 | 100.0% |
...
| `yolo` | 42 | `dispersion_reduction` | 74 | clock | 1 | 1 | 0.0% |
...
| `yolo` | 42 | `dispersion_reduction` | 74 | clock | 1 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 77 | teddy bear | 2 | 1 | 50.0% |
| `yolo` | 42 | `dispersion_reduction` | 0 | person | 43 | 17 | 60.5% |
| `yolo` | 42 | `dispersion_reduction` | 2 | car | 3 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 4 | airplane | 2 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 5 | bus | 4 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 7 | truck | 1 | 0 | 100.0% |
...
| `yolo` | 42 | `dispersion_reduction` | 47 | apple | 2 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 55 | cake | 1 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 56 | chair | 4 | 2 | 50.0% |
| `yolo` | 42 | `dispersion_reduction` | 58 | potted plant | 2 | 1 | 50.0% |
| `yolo` | 42 | `dispersion_reduction` | 59 | bed | 2 | 1 | 50.0% |
| `yolo` | 42 | `dispersion_reduction` | 60 | dining table | 2 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 62 | tv | 3 | 0 | 100.0% |
...
| `yolo` | 42 | `dispersion_reduction` | 74 | clock | 1 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 77 | teddy bear | 2 | 1 | 50.0% |
| `yolo` | 42 | `dispersion_reduction` | 0 | person | 43 | 10 | 76.7% |
| `yolo` | 42 | `dispersion_reduction` | 2 | car | 3 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 4 | airplane | 2 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 5 | bus | 4 | 0 | 100.0% |
| `yolo` | 42 | `dispersion_reduction` | 7 | truck | 1 | 0 | 100.0% |
...
| `yolo` | 42 | `square` | 30 | skis | 3 | 1 | 66.7% |
| `yolo` | 42 | `square` | 34 | baseball bat | 1 | 0 | 100.0% |
| `yolo` | 42 | `square` | 35 | baseball glove | 1 | 1 | 0.0% |
| `yolo` | 42 | `square` | 38 | tennis racket | 2 | 0 | 100.0% |
| `yolo` | 42 | `square` | 40 | wine glass | 4 | 0 | 100.0% |
| `yolo` | 42 | `square` | 41 | cup | 2 | 0 | 100.0% |
| `yolo` | 42 | `square` | 45 | bowl | 1 | 0 | 100.0% |
...
| `yolo` | 42 | `square` | 74 | clock | 1 | 0 | 100.0% |
| `yolo` | 42 | `square` | 77 | teddy bear | 2 | 2 | 0.0% |
| `yolo` | 42 | `deepfool` | 0 | person | 576 | 133 | 76.9% |
| `yolo` | 42 | `deepfool` | 1 | bicycle | 8 | 3 | 62.5% |
| `yolo` | 42 | `deepfool` | 2 | car | 46 | 5 | 89.1% |
| `yolo` | 42 | `deepfool` | 3 | motorcycle | 27 | 4 | 85.2% |
| `yolo` | 42 | `deepfool` | 4 | airplane | 9 | 4 | 55.6% |
| `yolo` | 42 | `deepfool` | 5 | bus | 20 | 5 | 75.0% |
| `yolo` | 42 | `deepfool` | 6 | train | 9 | 3 | 66.7% |
| `yolo` | 42 | `deepfool` | 7 | truck | 6 | 1 | 83.3% |
| `yolo` | 42 | `deepfool` | 8 | boat | 4 | 1 | 75.0% |
| `yolo` | 42 | `deepfool` | 9 | traffic light | 5 | 1 | 80.0% |
| `yolo` | 42 | `deepfool` | 10 | fire hydrant | 7 | 5 | 28.6% |
| `yolo` | 42 | `deepfool` | 11 | stop sign | 3 | 3 | 0.0% |
| `yolo` | 42 | `deepfool` | 12 | parking meter | 4 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 13 | bench | 5 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 14 | bird | 15 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 15 | cat | 17 | 2 | 88.2% |
| `yolo` | 42 | `deepfool` | 16 | dog | 9 | 1 | 88.9% |
| `yolo` | 42 | `deepfool` | 17 | horse | 24 | 1 | 95.8% |
| `yolo` | 42 | `deepfool` | 18 | sheep | 17 | 5 | 70.6% |
| `yolo` | 42 | `deepfool` | 19 | cow | 6 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 20 | elephant | 13 | 4 | 69.2% |
| `yolo` | 42 | `deepfool` | 21 | bear | 4 | 4 | 0.0% |
| `yolo` | 42 | `deepfool` | 22 | zebra | 25 | 17 | 32.0% |
...
| `yolo` | 42 | `deepfool` | 29 | frisbee | 8 | 2 | 75.0% |
| `yolo` | 42 | `deepfool` | 30 | skis | 10 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 31 | snowboard | 2 | 1 | 50.0% |
| `yolo` | 42 | `deepfool` | 32 | sports ball | 13 | 2 | 84.6% |
| `yolo` | 42 | `deepfool` | 33 | kite | 9 | 3 | 66.7% |
...
| `yolo` | 42 | `deepfool` | 56 | chair | 54 | 3 | 94.4% |
| `yolo` | 42 | `deepfool` | 57 | couch | 12 | 3 | 75.0% |
| `yolo` | 42 | `deepfool` | 58 | potted plant | 9 | 0 | 100.0% |
| `yolo` | 42 | `deepfool` | 59 | bed | 13 | 4 | 69.2% |
| `yolo` | 42 | `deepfool` | 60 | dining table | 27 | 4 | 85.2% |
| `yolo` | 42 | `deepfool` | 61 | toilet | 10 | 3 | 70.0% |
| `yolo` | 42 | `deepfool` | 62 | tv | 23 | 1 | 95.7% |
| `yolo` | 42 | `deepfool` | 63 | laptop | 26 | 2 | 92.3% |
...
| `yolo` | 42 | `deepfool` | 75 | vase | 8 | 1 | 87.5% |
| `yolo` | 42 | `deepfool` | 77 | teddy bear | 6 | 5 | 16.7% |
