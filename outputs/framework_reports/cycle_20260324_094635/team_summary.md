...
- Total discovered runs: **26**
- Attack runs analyzed: **25**
...
| `defended_deepfool_random_resize` | `deepfool` | 76.2% | 0.8165 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `defended_blur_random_resize` | `blur` | 42.9% | 0.7765 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `defended_eot_pgd_random_resize` | `eot_pgd` | 33.3% | 0.8025 | n/a | proxy (avg_conf) | Strong attack effect |
