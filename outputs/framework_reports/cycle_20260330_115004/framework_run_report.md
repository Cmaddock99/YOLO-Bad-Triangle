...
| `attack_deepfool` | `yolo` | `deepfool` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7271 |
| `attack_dispersion_reduction` | `yolo` | `dispersion_reduction` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7951 |
| `attack_eot_pgd` | `yolo` | `eot_pgd` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7928 |
| `attack_fgsm` | `yolo` | `fgsm` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7764 |
| `attack_pgd` | `yolo` | `pgd` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7503 |
| `attack_square` | `yolo` | `square` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7183 |
| `baseline_none` | `yolo` | `none` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7623 |
| `consistency_atk_square` | `yolo` | `square` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7544 |
| `defended_deepfool_bit_depth` | `yolo` | `deepfool` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.7219 |
| `defended_deepfool_c_dog` | `yolo` | `deepfool` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7710 |
| `defended_deepfool_jpeg_preprocess` | `yolo` | `deepfool` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `missing` |  | 0.7870 |
| `defended_deepfool_median_preprocess` | `yolo` | `deepfool` | `` | `` | `median_preprocess` | `legacy_unknown` | `missing` |  | 0.7746 |
| `defended_dispersion_reduction_bit_depth` | `yolo` | `dispersion_reduction` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.7595 |
| `defended_dispersion_reduction_c_dog` | `yolo` | `dispersion_reduction` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7444 |
| `defended_dispersion_reduction_jpeg_preprocess` | `yolo` | `dispersion_reduction` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `missing` |  | 0.7423 |
| `defended_dispersion_reduction_median_preprocess` | `yolo` | `dispersion_reduction` | `` | `` | `median_preprocess` | `legacy_unknown` | `missing` |  | 0.7469 |
| `defended_square_bit_depth` | `yolo` | `square` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.7400 |
| `defended_square_c_dog` | `yolo` | `square` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7468 |
| `defended_square_jpeg_preprocess` | `yolo` | `square` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `missing` |  | 0.7403 |
| `defended_square_median_preprocess` | `yolo` | `square` | `` | `` | `median_preprocess` | `legacy_unknown` | `missing` |  | 0.7397 |
| `tune_atk_deepfool__epsilon0.05__steps50` | `yolo` | `deepfool` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7463 |
| `tune_atk_deepfool__epsilon0.1__steps20` | `yolo` | `deepfool` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7574 |
| `tune_atk_deepfool__epsilon0.1__steps50` | `yolo` | `deepfool` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7354 |
| `tune_atk_deepfool__epsilon0.1__steps80` | `yolo` | `deepfool` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7323 |
| `tune_atk_deepfool__epsilon0.2__steps50` | `yolo` | `deepfool` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.8045 |
| `tune_atk_deepfool_best` | `yolo` | `deepfool` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7354 |
| `tune_atk_dispersion_reduction__epsilon0.075__steps20` | `yolo` | `dispersion_reduction` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7634 |
| `tune_atk_dispersion_reduction__epsilon0.15__steps20` | `yolo` | `dispersion_reduction` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7351 |
| `tune_atk_dispersion_reduction__epsilon0.15__steps40` | `yolo` | `dispersion_reduction` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7697 |
| `tune_atk_square__eps0.15__n_queries450` | `yolo` | `square` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7627 |
| `tune_atk_square__eps0.3__n_queries400` | `yolo` | `square` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7400 |
| `tune_atk_square__eps0.3__n_queries450` | `yolo` | `square` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7082 |
| `tune_atk_square__eps0.3__n_queries500` | `yolo` | `square` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7832 |
| `tune_atk_square_best` | `yolo` | `square` | `` | `` | `none` | `legacy_unknown` | `missing` |  | 0.7082 |
| `tune_def_bit_depth__bits5_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.7299 |
| `tune_def_bit_depth__bits5_vs_square` | `yolo` | `square` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.7302 |
| `tune_def_bit_depth__bits6_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.8157 |
| `tune_def_bit_depth__bits6_vs_square` | `yolo` | `square` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.7409 |
| `tune_def_bit_depth__bits7_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.7530 |
| `tune_def_bit_depth__bits7_vs_square` | `yolo` | `square` | `` | `` | `bit_depth` | `legacy_unknown` | `missing` |  | 0.7285 |
| `tune_def_c_dog__sharpen_alpha0.35__timestep25_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7838 |
| `tune_def_c_dog__sharpen_alpha0.35__timestep25_vs_square` | `yolo` | `square` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7232 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep10_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7674 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep10_vs_square` | `yolo` | `square` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7634 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep25_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7999 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep25_vs_square` | `yolo` | `square` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7566 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep40_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7750 |
| `tune_def_c_dog__sharpen_alpha0.55__timestep40_vs_square` | `yolo` | `square` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7313 |
| `tune_def_c_dog__sharpen_alpha0.7__timestep25_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7617 |
| `tune_def_c_dog__sharpen_alpha0.7__timestep25_vs_square` | `yolo` | `square` | `` | `` | `c_dog` | `legacy_unknown` | `missing` |  | 0.7324 |
| `tune_def_jpeg_preprocess__quality45_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `missing` |  | 0.7818 |
| `tune_def_jpeg_preprocess__quality45_vs_square` | `yolo` | `square` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `missing` |  | 0.7846 |
| `tune_def_jpeg_preprocess__quality60_vs_deepfool` | `yolo` | `deepfool` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `missing` |  | 0.7670 |
| `tune_def_jpeg_preprocess__quality60_vs_square` | `yolo` | `square` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `missing` |  | 0.7489 |
| `validate_atk_deepfool` | `yolo` | `deepfool` | `` | `` | `none` | `legacy_unknown` | `complete` | 0.2184 | 0.7562 |
| `validate_atk_dispersion_reduction` | `yolo` | `dispersion_reduction` | `` | `` | `none` | `legacy_unknown` | `complete` | 0.2381 | 0.6761 |
| `validate_atk_square` | `yolo` | `square` | `` | `` | `none` | `legacy_unknown` | `complete` | 0.3630 | 0.7195 |
| `validate_baseline` | `yolo` | `none` | `` | `` | `none` | `legacy_unknown` | `complete` | 0.6002 | 0.7648 |
| `validate_deepfool_bit_depth` | `yolo` | `deepfool` | `` | `` | `bit_depth` | `legacy_unknown` | `complete` | 0.2229 | 0.7465 |
| `validate_deepfool_c_dog` | `yolo` | `deepfool` | `` | `` | `c_dog` | `legacy_unknown` | `complete` | 0.2403 | 0.7533 |
| `validate_deepfool_jpeg_preprocess` | `yolo` | `deepfool` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `complete` | 0.1663 | 0.7613 |
| `validate_dispersion_reduction_bit_depth` | `yolo` | `dispersion_reduction` | `` | `` | `bit_depth` | `legacy_unknown` | `complete` | 0.2319 | 0.7128 |
| `validate_dispersion_reduction_c_dog` | `yolo` | `dispersion_reduction` | `` | `` | `c_dog` | `legacy_unknown` | `complete` | 0.2632 | 0.7244 |
| `validate_dispersion_reduction_jpeg_preprocess` | `yolo` | `dispersion_reduction` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `complete` | 0.2015 | 0.6834 |
| `validate_square_bit_depth` | `yolo` | `square` | `` | `` | `bit_depth` | `legacy_unknown` | `complete` | 0.3863 | 0.7466 |
| `validate_square_c_dog` | `yolo` | `square` | `` | `` | `c_dog` | `legacy_unknown` | `complete` | 0.3890 | 0.7274 |
| `validate_square_jpeg_preprocess` | `yolo` | `square` | `` | `` | `jpeg_preprocess` | `legacy_unknown` | `complete` | 0.3767 | 0.7404 |
