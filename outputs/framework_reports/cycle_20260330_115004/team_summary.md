...
| `validate_dispersion_reduction_jpeg_preprocess` | `dispersion_reduction` | 66.0% | 0.6834 | 0.2015 | ✓ mAP50 | Strong attack effect |
...
| `validate_square_jpeg_preprocess` | `square` | 30.0% | 0.7404 | 0.3767 | ✓ mAP50 | Strong attack effect |
...
| `validate_deepfool_jpeg_preprocess` | `deepfool` | -74.0% | 0.7613 | 0.1663 | ✓ mAP50 | Strong attack effect |
