...
- Total discovered runs: **56**
- Attack runs analyzed: **54**
- Baseline run: `baseline_none`

## Headline

- Strongest attack (by detection drop): `deepfool` (90.5%)
...
|---|---|---:|---:|---:|---|---|
| `tune_def_median_preprocess_002` | `deepfool` | 90.5% | 0.7735 | n/a | proxy (avg_conf) | Strong attack effect |
| `defended_deepfool_c_dog_ensemble` | `deepfool` | 85.7% | 0.8318 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_001` | `deepfool` | 81.0% | 0.8289 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_003` | `deepfool` | 81.0% | 0.8709 | n/a | proxy (avg_conf) | Strong attack effect |
| `tune_def_median_preprocess_004` | `deepfool` | 81.0% | 0.8289 | n/a | proxy (avg_conf) | Strong attack effect |
...
| `tune_def_median_preprocess_005` | `deepfool` | 71.4% | 0.7835 | n/a | proxy (avg_conf) | Strong attack effect |
